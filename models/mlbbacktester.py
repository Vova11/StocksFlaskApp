...
class MLBacktester(Fin):
    ...
    def __init__(self, ticker, tc=0.00007):
        ...
        self.model = LogisticRegression(
            C=1e6, max_iter=100000, multi_class="ovr")
        self.results = None

    def __repr__(self):
        rep = "MLBacktester(symbol = {}, tc = {})"
        return rep.format(self.symbol, self.tc)
    ...
    def fit_model(self, start, end):
        ...
        self.model.fit(self.data_subset[self.feature_columns], np.sign(
    ...
    def test_strategy(self, train_ratio=0.7, lags=5):
        ...
        self.data_subset.strategy = self.data_subset.strategy - \
            self.data_subset.trades * self.tc
    ...
    def plot_results(self):
        ...
        if self.results is None:
            ...
            title = "Logistic Regression: {} | TC = {}".format(
                self.ticker, self.tc)
